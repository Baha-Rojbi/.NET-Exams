...
builder.Services.AddScoped<IServiceExpertise, ServiceExpertise>();
builder.Services.AddScoped<IServiceExpert, ServiceExpert>();
builder.Services.AddScoped<IServiceSinistre, ServiceSinistre>();
